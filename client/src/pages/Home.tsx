        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          <header className="text-center mb-12">
            ...
            <div className="flex justify-center gap-4">
              <Link href="/simple-demo" className="inline-block bg-green-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-green-700 transition-colors">
                Try Simple Chat Demo
              </Link>
              <Link href="/chat" className="inline-block bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors">
                Try Main Chat
              </Link>
            </div>
          </header>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 mb-12 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleWebpageSubmit} className="flex flex-col sm:flex-row gap-3">
              <div className="flex-1">
                ...
                />
                {urlError && (
                    <p className="text-red-500 text-sm mt-1" role="alert">{urlError}</p>
                )}
              </div>
              <button
                  type="submit"
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow overflow-hidden border border-gray-100">
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  ...
                  <span className="bg-blue-100 text-blue-600 rounded-full p-1 mr-2" aria-hidden="true">
                ...
                <Link href="/chat" className="block text-center py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
                  Join a Chat Room
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow overflow-hidden border border-gray-100">
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center text-gray-700">
                  <span className="bg-indigo-100 text-indigo-600 rounded-full p-1 mr-2" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="20 6 9 17 4 12"></polyline>
                    </svg>
                  </span>
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow overflow-hidden border border-gray-100">
              <div className="p-6">
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mb-4">
                  <Code className="h-6 w-6 text-purple-600" aria-hidden="true" />
                </div>
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center text-gray-700">
                  <span className="bg-purple-100 text-purple-600 rounded-full p-1 mr-2" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="20 6 9 17 4 12"></polyline>
                    </svg>
                  </span>
